...
class TfpDistribution(Distribution):
    ...
    def __init__(self, distribution):
        ...
        super(TfpDistribution, self).__init__(distribution.dtype, True, distribution.reparameterization_type is tfp.distributions.FULLY_REPARAMETERIZED,
            distribution.batch_shape, distribution.batch_shape, len(distribution.event_shape))
